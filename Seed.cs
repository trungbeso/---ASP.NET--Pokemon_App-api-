...
namespace PokemonReviewApp.Api;
                    ...
                    Pokemon = new Pokemon()
                    {
                        ...
                        Reviews = new List<Review>()
                        {
                            new Review
                            {
                                ...
                                Rating = 5,
                                Author = new Reviewer() { FirstName = "Teddy", LastName = "Smith" }
                            },
                            new Review
                            {
                                Title = "Pikachu", Text = "Pickachu is the best a killing rocks", Rating = 5,
                                Author = new Reviewer() { FirstName = "Taylor", LastName = "Jones" }
                            },
                            new Review
                            {
                                Title = "Pikachu", Text = "Pickchu, pickachu, pikachu", Rating = 1,
                                Author = new Reviewer() { FirstName = "Jessica", LastName = "McGregor" }
                            },
                        }
                    },
                    Owner = new Owner()
